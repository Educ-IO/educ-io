...
permalink: /tools/drive-migration
colour: 0f5c60
lead: A command line tool for migrating files and folders to Google Drive.
---
{% capture lead %}
...
{% endcapture %}
{% include extension.html logo="images/cloudysky.svg" url="https://chrome.google.com/webstore/detail/cloudysky/ankfkbhcljebidkfgjkhgpkjmlbigkgd" action="Download" %}