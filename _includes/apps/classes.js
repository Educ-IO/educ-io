App = function() {
  ...
  FN.export = {
    ...
    file: () => ಠ_ಠ.Display.state().in(FN.states.overview.in) ? "Google Classroom Overview" : ಠ_ಠ.Display.state().in(FN.states.classwork.in) ? "Google Classwork Overview" : "Overview",

    table: () => ಠ_ಠ.Display.state().in(FN.states.overview.in) ? "Classes" : ಠ_ಠ.Display.state().in(FN.states.classwork.in) ? "Classwork" : "Data",
  ...
  FN.setup = {
    ...
    initial: () => {
      ...
      _.each(["Common", "Populate", "People", "Classes", "Overview", "Usage", "Engagement", "Roster", "Classwork", "Submissions"],
