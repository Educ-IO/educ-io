  ...
  scale: [
    ...
    /* <!-- Standard 6 --> */
    {
      ...
      criteria: [{
        ...
        name: "Secure",
        value: 2,
        __details__: "Able to __assess__ pupils’ attainment __accurately__ against national benchmarks. Employ a range of appropriate formative assessment strategies effectively and adapt teaching within lessons in light of pupils’ responses.  Maintain accurate records of pupils’ progress and use these to set appropriately challenging targets. Assess learners’ progress __regularly__ and accurately whilst __discussing assessments__ with them so that learners know how well they have done and what they need to do to improve."
      }, {
        name: "Excellent",
        value: 3,
        __details__: "__Confidently__ and __accurately__ assess pupils’ attainment against national benchmarks.  Use a range of assessment strategies __very effectively__ in day-to-day practice to monitor progress and to inform future planning.  Systematically and effectively check learners’ understanding throughout lessons, __anticipating where intervention__ may be needed and do so with __otable impact__ on the __quality of learning__.  Assess learners’ progress regularly and work with them to accurately target further improvement and __secure rapid progress__."
      }],
      children: [{
        number: 1,
