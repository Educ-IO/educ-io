States = () => {
  ...
  const STATE_FILE_LOADED = "loaded-file",
    ...
    STATE_TRACKER_EDITABLE = "editable-tracker",
    ...
    STATES = [STATE_FILE_LOADED, STATE_FORM_OPENED, STATE_TRACKER, STATE_TRACKER_OPENED, STATE_TRACKER_EDITABLE,
  ...
  return {
    ...
    report : {
      ...
      autosave : STATE_REPORT_AUTOSAVE,
    },
    ...
    tracker : {
      ...
      editable : STATE_TRACKER_EDITABLE,
    },
